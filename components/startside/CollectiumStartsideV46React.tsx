  ...
  return (
    ...
    >
      ...
      <section id="katalog" className={styles.catalog}>
        <div className={styles.wrapWide}>
          <Roman nr="III" label="Katalog" />
          <h2 className={styles.sectionH}>Katalogen viser objektet i sammenheng.</h2>
          <p className={styles.sectionLead}>
            Samme objekt kan leses gjennom Samler, Historie og Finans uten at data hardkodes i frontend.
          </p>
          ...
          <div className={styles.segmentBar}>
            {(["samler", "historie", "finans"] as CatalogSegment[]).map((item) => (
              <button
                key={item}
                type="button"
                className={catalogSegment === item ? styles.isActive : ""}
          ...
          <div className={styles.catalogDemo}>
            <aside className={styles.segmentInfo}>
              <span>{selectedSegment.meta}</span>
            ...
            <div className={styles.objectGrid}>
              {catalogCards.map((card) => (
                <a className={styles.objCard} href="/katalog" key={card.source}>
                  <div className={styles.objValue}>{card.value}</div>
                  <div>
                    <strong>{card.ruler}</strong>
          ...
          <div className={styles.centerActions}>
            <a className={`${styles.btn} ${styles.btnPrimary}`} href="/katalog">Bla i hele katalogen</a>
            <a className={`${styles.btn} ${styles.btnSecondary}`} href="/katalog?filter=avansert">Avansert søk</a>
          </div>
        </div>
      </section>
